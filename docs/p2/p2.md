...
위 그림에서 GDT 의 구조를 알 수 있다 (ref. [IA-32 Intel Architecture Software Developer's Manual Volume 3A](https://flint.cs.yale.edu/cs422/doc/24547212.pdf)). 
이 구조중에서 중요한 부분은 DPL 인데, DPL 은 Descriptor Privilege Level 의 약자로서
