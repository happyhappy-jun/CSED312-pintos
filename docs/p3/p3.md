...
void sys_munmap(mmapid_t mapping){
  ...
  // 2-1. if page is in swap, temp frame 에 swap in 한 후, check if dirty, and write back 
...
"3. Supplemetal page table"에서 언급한 Delete supplemental page table entry와 Destroy supplemental page table을 활용하여
